...
from core.agents.integration_code_block_agent import (
    IntegrationCodeAgentResponse,
    IntegrationCodeSnippetAgentInput,
    integration_code_snippet_agent,
)
...
AI_GENERATED_CODE_DISCLAIMER = """
This code was generated by a WorkflowAI agent. Always refer to the [WorkflowAI documentation](https://docs.workflowai.com/) when in doubt. Please send a 👎 when the code is not working as expected.
"""
...
"""
    ...
    async def stream_code_for_version(
        ...
        response = IntegrationCodeAgentResponse(code="", feedback_token=None)
        async for response in integration_code_snippet_agent(doc_gen_input):
            yield VersionCode(
                code=response.code,
                integration=integration,
                feedback_token=response.feedback_token,
            )

        # Send the final code snippet with the disclaimer
        yield VersionCode(
