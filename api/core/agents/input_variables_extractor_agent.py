...
class InputVariablesExtractorOutput(BaseModel):
    ...
    messages_with_input_variables: list[LLMCompletionMessage]
...
Then you must propose a templated version of the messages with placeholders to inject the variables surrounded by double curly braces in 'message_with_input_variables.content'
