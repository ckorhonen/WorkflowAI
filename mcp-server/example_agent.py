...
"""This code is used as an example of what a canonical workflow agent looks like.
"""

WORKFLOWAI_API_URL = "http://localhost:8000/v1"  # This is the default URL for the WorkflowAI API
WORKFLOWAI_API_KEY = os.environ["WORKFLOWAI_API_KEY"]  # Get your API key with 5$ in workflowai.com/keys


client = openai.OpenAI(
    api_key=WORKFLOWAI_API_KEY,
    base_url=WORKFLOWAI_API_URL,  # OpenAI SDK now uses the workflowai API URL as the base URL
)
...
response = client.beta.chat.completions.parse(
    model="meeting-summarizer/gpt-4o-mini-latest",
    messages=[  # Message contains the "static" parts of the agents instructions, with same placeholder {{}} where variables will be injected at runtime
        {
            ...
            If you need to fetch url you can use the @browser-text tool.
            """,
        },
        {
            "role": "user",
