...
⚠️ **Cannot run tests in current environment**: The test environment lacks required dependencies (pydantic, pytest, etc.). However, based on the code structure and comprehensive test coverage, the implementation should work correctly.
