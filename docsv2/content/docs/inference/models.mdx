...
<Callout type="info">
  To properly organize your observability data, you can identify your agent by adding `agent_id` to your metadata. This helps you track and debug runs for specific agents. Learn more about [identifying your agent](/docs/observability#identify-your-agent).
</Callout>
