...
- `low` reasoning effort uses at most **20%** of the maximum output tokens of the model
- `medium` reasoning effort uses at most **50%** of the maximum output tokens of the model
- `high` reasoning effort uses at most **80%** of the maximum output tokens of the model

In the inverse, the reasoning budget is converted to a reasoning effort:
- `0` disables reasoning when possible
- up to **20%** of the maximum output tokens of the model is converted to `low`
- between **20%** and **50%** of the maximum output tokens of the model is converted to `medium`
- above **50%** of the maximum output tokens of the model is converted to `high`
...
It is also possible to filter out reasoning models via the `reasoning` query parameter.
