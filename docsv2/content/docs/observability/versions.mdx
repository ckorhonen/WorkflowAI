...
![Version 2 is a major version, version 2.1 is version 2 running on Gemini 2.0](/images/observability/versions/versions.png)
...
![Save a version](/images/observability/versions/save-version.png)

Additionnaly, you can save all versions currently running by clicking on the "Save all versions" button.

![Save all versions](/images/observability/versions/save-all-versions.png)
...
![List of all versions](/images/observability/versions/versions-section-full.png)
...
<div style={{ position: 'relative', paddingTop: '56.25%' }}>
  <iframe
    src="https://customer-turax1sz4f7wbpuv.cloudflarestream.com/be1801a4342a1352fa5aa9aa7f5da707/iframe?autoplay=false&muted=false&controls=true"
    style={{ 
      border: 'none', 
      position: 'absolute', 
      top: 0, 
