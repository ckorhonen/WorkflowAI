      ...
      <table className="w-full border-collapse">
        <thead>
          <tr className="border-b border-border">
            ...
            <th className="text-center p-2 font-semibold" title="Input Image">🖼️</th>
            <th className="text-center p-2 font-semibold" title="Input PDF">📄</th>
            <th className="text-center p-2 font-semibold" title="Input Audio">🎵</th>
            <th className="text-center p-2 font-semibold" title="Output Image">🎨</th>
            <th className="text-center p-2 font-semibold" title="Output Text">💬</th>
            <th className="text-center p-2 font-semibold" title="JSON Mode">{ }</th>
            <th className="text-center p-2 font-semibold" title="Tool Calling">🔧</th>
            <th className="text-center p-2 font-semibold" title="Structured Output">📊</th>
          </tr>
        </thead>
        <tbody>
          {models.map((model) => (
