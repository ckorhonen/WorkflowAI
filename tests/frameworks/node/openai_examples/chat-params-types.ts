...
export async function createCompletionParams(stream: true): Promise<OpenAI.Chat.ChatCompletionCreateParamsStreaming>;
export async function createCompletionParams(
  stream: false
): Promise<OpenAI.Chat.ChatCompletionCreateParamsNonStreaming>;
export async function createCompletionParams(stream: boolean): Promise<OpenAI.Chat.ChatCompletionCreateParams> {
  const params = {
    model: 'gpt-3.5-turbo',
